...
def start():
    global snake_direction, snake, food_pos
    snake_direction = "up" #default direction
...
#start showing the second step to setting up
...
#This pen draws our food
food = turtle.Turtle("circle")
food.color('red')
food.penup()

#Event handler (calls control functions)
window.listen()
