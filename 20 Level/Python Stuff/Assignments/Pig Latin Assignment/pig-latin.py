...
def pig_latin_process_strings(string: str):
    ...
    Returns:
        pig_latin_string (str): All sthe words translated and joined together to form one string
...
def record_results(original_string: str, pig_latin_string: str):
    ...
    translation_record.write("-" * 200)
    translation_record.write(f"\n{(datetime.now()).strftime('%Y-%m-%d %H:%M:%S')}\n")
    translation_record.write("\nOriginal:\n")
...
# Recording the "onstage" stuff for later watching
